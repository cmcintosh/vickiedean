...
/* themes/custom/vickie_dean_themes/templates/views/views-view-fields--product_catalog2--block_1.html.twig */
class __TwigTemplate_755c39eda4d8b26cffe040f5c2de4f1ff588deb209bf0a30240ee89c515441f5 extends Twig_Template
{
...
";
    ...
    {
        return "themes/custom/vickie_dean_themes/templates/views/views-view-fields--product_catalog2--block_1.html.twig";
    }
...
/* 		</div>*/
/* 		<div class="price">{{fields.field_product_name.content}} </div>*/
/* 	</div>*/
/* 	<div class="cart-button">*/
/* 		<button class="product-btn-add" type="button" onclick="ajaxAdd($(this),36);">*/
/* 			<i class="material-design-shopping231"></i>*/
/* 			<span class="hidden-xs hidden-sm hidden-md">{{fields.field_product_name.content}}</span>*/
/* 		</button>*/
/* 	</div>*/
/* 	<div class="cart-buttons">*/
/* 		<button class="product-btn" type="button" data-toggle="tooltip" title="Add to Wish List" onclick="wishlist.add('36');">*/
