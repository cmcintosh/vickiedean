	...
	if (o.length > 0) {
		$(document).ready(function () {
			o.owlCarousel({
				...
				pagination: false,
				navigation: true,
				navigationText: ['<i class="material-icons-keyboard_backspace"></i>', '<i class="material-icons-keyboard_backspace"></i>'],
			});
		});
	}
})(jQuery);
...
;
(function ($) {
	$( ".btn, .quickview, .slide_btn, .check-btn, .product-btn-add, .newsletter-popup-btn" ).wrapInner( "<span></span>");
	$( ".s-desc > .btn" ).addClass( "animated" );
	$( ".s-desc > .btn" ).hover(
     	function() {
     	 	$(this).addClass( "pulse" );
     	},
