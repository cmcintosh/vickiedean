...
/**
 * Provides a list controller for VickieReportFileUpload entity.
 *
 * @ingroup vickie
 */
class VickieReportFileUploadListBuilder extends EntityListBuilder {
  ...
  /**
   * Constructs a new VickieReportFileUploadListBuilder object.
   *
